...
//=============================================================================
 /*:
 * @plugindesc v1.06 (Requires YEP_BattleEngineCore.js) Add ATB (Active
...
Game_Battler.prototype.onATBStart = function() {
    ...
    this.applyPreemptiveBonus();
    this.applySurpriseBonus();
    this.refresh();
};

Game_Battler.prototype.applyPreemptiveBonus = function() {
...
Game_Battler.prototype.applySurpriseBonus = function() {
